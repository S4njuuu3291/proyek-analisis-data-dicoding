...
def load_data():
    customers_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\customers_dataset.csv")
    geolocation_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\geolocation_dataset.csv")
    orders_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\orders_dataset.csv")
    order_items_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\order_items_dataset.csv")
    order_payments_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\order_payments_dataset.csv")
    order_reviews_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\order_reviews_dataset.csv")
    product_category_name_tr_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\product_category_name_translation.csv")
    products_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\products_dataset.csv")
    sellers_df = pd.read_csv("C:\\Users\\Sanju\\OneDrive\\Documents\\BANGKIT_ACADEMY\\3-ANALISIS-DATA-PYTHON\\proyek-analisis-data-dicoding\\data\\sellers_dataset.csv")
